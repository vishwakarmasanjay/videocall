...
var conn = new WebSocket('wss://ecouat.kiya.ai:4443');
    ...
    if (success === false) {
        ...
        navigator.webkitGetUserMedia({ video: true, audio: { 'echoCancellation': true }, }, function(myStream) {
            ...
            yourConn.onaddstream = function(e) {
                ...
                remoteVideo.srcObject = e.stream.getAudioTracks();
            };
...
callBtn.addEventListener("click", function() {
    ...
    if (callToUsername.length > 0) {
        ...
        yourConn.createOffer(function(offer) {
            ...
            hangUpBtn.style.bottom = '1px';
            hangUpBtn.style.left = '10em';
